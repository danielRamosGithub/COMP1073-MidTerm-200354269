...
/** Injecting of content on the "LANDING PAGE" **/

// IntroParagraph parapragh
let IntroParagraphtxt = `Now is the time to travel to Greece. The country may be going through an economic crisis, but many travellers say that it hasn't impacted the experience of visiting. Plus, there may be some great deals. 
...
IntroParagraph.innerText = IntroParagraphtxt;
...
Folegandros.innerText = Folegandrostxt;
...
Alonissos.innerText = Alonissostxt;
